...
import ca.xamercier.horizon.rocket.utils.i2c.mpu6050.I2CComponent;
...
public class MPU6050 extends I2CComponent {
     ...
     */
    public MPU6050() throws UnsupportedBusNumberException, InterruptedException {
     ...
     * @throws InterruptedException 
     */
    public MPU6050(int i2cAddress, int dlpfCfg, int smplrtDiv) throws UnsupportedBusNumberException, InterruptedException {
        super(i2cAddress);
     ...
     * @throws InterruptedException 
     */
    private void calibrateSensors() throws InterruptedException {
        int nbReadings = 50;
